...
echo -e "\e[1;94mAttempting to update to Ubuntu 14.10 Utopic Unicorn. It will take few minutes to complete, hold on.\n\nRELEASE INFO ---------------------\n$(lsb_release -d -r -c)\n----------------------------------\n\n\e[0;0m" >> $log
...
# Exit
echo -e "\e[1;92m\n\nYour Bowery environment has been updated to Utopic Unicorn. It's safe to save and restart your environment now.\n\nRELEASE INFO ---------------------\n$(lsb_release -d -r -c)\n----------------------------------\n\n\e[0;0m" >> $log
t=$((`date +%s` + 10))
while [[ "$t" -ne `date +%s` ]]; do
